...
function Menu() {
    return (
        <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark">
            <Container>
                <Navbar.Brand href="#home">ATF</Navbar.Brand>
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    ...
                    <Nav>
                        <NavDropdown title="Aministración" id="collasible-nav-dropdown">
                            <NavDropdown.Item href="#edit-profile"><Icon icon={faMoneyBillWave} /> Puntis</NavDropdown.Item>
                            <NavDropdown.Item href="#edit-profile"><Icon icon={faUserCircle} /> Participantes</NavDropdown.Item>
                            <NavDropdown.Item href="#edit-profile"><Icon icon={faGlassCheers} /> Fiestas</NavDropdown.Item>
                        </NavDropdown>
                    </Nav>
                    <Nav>
